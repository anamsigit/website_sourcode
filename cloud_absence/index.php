...
if($idpelanggan == "reset"){
  ...
  ////////////////////////////////////////////////////////////////////////////////////
$formatawal = @$_POST['simpanformatawal']; 

 if($formatawal == ""){
  
  }else{
    
  $hubungsql= "INSERT INTO penampung_db (format_awal, sesi) VALUES( '$formatawal', 1)";
  $hasil=mysqli_query($connect,$hubungsql);
  $result = mysqli_query($connect, "SELECT * FROM penampung_db WHERE sesi ='1' ");
  }
...
<body><center>
  ...
  <form method = "post">
    ...
    <div class="mb-3">
      <input name="simpanformatawal" placeholder="  tuliskan format awal" type="form" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
      style=" position: relative; top :20px; left :5px;">
    </div>
...
<!-- script javascript ini akan mengkopi yang ada didalam span, coba cermati apa yang diapit oleh span -->
<!-- CARA KERJA -->
<!-- form akan mengambil input dengan metode post, diambil datanya ke database, kemudian dari databse akan ditampilkan ke UI, koding untuk
menampilkan tersebut dibungkus sebuah span dimana pembungkusan ini bertujuan untuk menjalankan fungsi copy dari java script -->
<!-- revisi saya akan menambhakan table baru untuk menyimpan format awal dari absen -->
